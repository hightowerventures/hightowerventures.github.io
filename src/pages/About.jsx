...
export default function About(){
  return (
    <main className="max-w-7xl mx-auto px-6 py-16">
      ...
      <p className="mt-4 text-gray-600 max-w-3xl">High Tower Ventures is an umbrella company registered in Nigeria with the mission to engineer the future across multiple sectors. Founded by Andikan Sampson, HTV focuses on long-term value creation through innovation, integrity, and impact. Our headquarters are in Uyo, and we're expanding across Africa and global markets.</p>
      ...
      <section className="mt-8">
        ...
        <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-lg p-6 shadow">
            <div className="font-semibold">Grace Adeniyi</div>
          ...
          <div className="bg-white rounded-lg p-6 shadow">
            <div className="font-semibold">Chijioke Okafor</div>
